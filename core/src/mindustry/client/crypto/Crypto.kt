...
object Crypto : Initializable {
    ...
    private val random = try { SecureRandom.getInstance("NativePRNGNonBlocking") } catch (e: NoSuchAlgorithmException) { try { SecureRandom.getInstance("WINDOWS-PRNG") } catch (e: NoSuchAlgorithmException) { SecureRandom() } }
